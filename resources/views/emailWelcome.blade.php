                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td  style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    <h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 24px; line-height: 125%; color: #333333; font-weight: normal;">عزيزينا {{$name}}</h1>
                                    <p style="margin: 0;">أهلا  وسهلاً بكم عميلنا العزيز في موقعنا الالكتروني ، نتمنى ان تكون خدماتنا مرضية ومميزة لك ، ونتشرف بإضافة مشاريعك وتواصلك معنا في اي وقت ، فحللت أهلاً ووطئت سهلاً</p>
                                </td>
                            </tr>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; text-align: center; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #ffffff;">
                                    <p style="margin: 0;">
                                        هذه  رسالة ترحيبية  تلقائية  من إدارة الموقع
                                        <br>
                                    مع تحياتنا الكاملة ، إدارة الموقع </p>
                                </td>
                            </tr>
                        </table>
                        <!--[if mso]>
