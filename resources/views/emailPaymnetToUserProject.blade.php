                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td  style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    ...
                                    <p style="margin: 0;">شكرا لسداد قيمة الترجمة يقوم الفريق المختص بمراجعة عملية السداد و المباشرة في تنفيذ الخدمة</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td  style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    ...
                                    <p style="margin: 0;">Thank you for paying the value of the translation The relevant team reviews the payment process and direct the implementation of the service</p>
                                </td>
                            </tr>
