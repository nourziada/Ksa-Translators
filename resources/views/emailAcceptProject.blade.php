...
<head>
    ...
    <title>كود التفعيل من موقع مزادنا</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                                <td style="text-align: right;padding-right: 40px; padding-bottom: 10px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    <span style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 125%; color: #333333; font-weight: bold;">قيمة الفاتورة المستقة مقابل الخدمة :  </span> <span style="margin: 0;">{{$price}} دولار</span>  <span style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 125%; color: #333333; font-weight: bold;"> ريال سعودي  </span>
                            ...
                            <tr>
                                <td  style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    ...
                                    <p style="margin: 0;">he translation request has been accepted, and the value of the service fee has been added. You can access your account and choose the appropriate method for paying the bill</p>
                                </td>
                            </tr>

                            <tr>
                                <td style="text-align: right;padding-right: 40px; padding-bottom: 10px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    <span style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 125%; color: #333333; font-weight: bold;">Value of bill due for service : SR :  </span> <span style="margin: 0;">{{$price}}</span> 
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; text-align: center; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #ffffff;">
                                    <p style="margin: 0;">
                                        هل تحتاج مساعدة ؟ مراسلتنا عبر البريد الالكتروني
                                        </p><br>
                                    <p style="margin: 0;"> <a href="" style="color: #fff;"> support@ksatranslators.com </a></p>
                                </td>
                            </tr>
                        </table>
                        <!--[if mso]>
