                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td  style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    ...
                                    رسالة جديدة من قسم تواصل معنا في موقعك الالكتروني</h1>
                                    <p style="margin: 0;">عزيزي مدير الموقع العزيز ، نتمنى ان تكون بصحة جيدة ، هناك رسالة جديدة من قسم تواصل معنا في موقعك الالكتروني وتفاصيلها الاسفل</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: right;padding-right: 40px; padding-bottom: 10px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    <span style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 125%; color: #333333; font-weight: bold;">الاسم : </span>
                            ...
                            <tr>
                                <td style="text-align: right;padding-right: 40px; padding-bottom: 10px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    <span style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 125%; color: #333333; font-weight: bold;">عنوان الرسالة : </span>
                            ...
                            <tr>
                                <td style="text-align: right;padding-right: 40px; padding-bottom: 10px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    <span style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 125%; color: #333333; font-weight: bold;">نص الرسالة : </span>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; text-align: center; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #ffffff;">
                                    <p style="margin: 0;">
                                    هذه رسالة تلقائية من قسم تواصل معنا في موقعك الالكتروني</p>
                                </td>
                            </tr>
                        </table>
                        <!--[if mso]>
